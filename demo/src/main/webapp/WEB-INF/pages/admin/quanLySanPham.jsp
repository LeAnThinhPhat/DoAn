		...
		<form class="form-inline" id="searchForm" name="searchObject">
			...
			<div class="form-group">
				<select class="form-control" name="donGia" id="price">
					...
					<option value="200-trieu-den-400-trieu">200 triệu đến 400
						triệu</option>
					<option value="400-trieu-den-600-trieu">400 triệu - 600
						triệu</option>
			...
			<div class="modal fade" id="chiTietModal" tabindex="-1" role="dialog"
				...
				<div class="modal-dialog " role="document" style="width: 60%">
					<div class="modal-content">
						<div class="modal-header">
							<h3 class="title"
								style="text-align: center; font-weight: bolder;">Chi tiết
								sản phẩm</h3>
							<button type="button" class="close" data-dismiss="modal"
								aria-label="Close">
								<span aria-hidden="true">&times;</span>
