$(document).ready(function(){
	...
	function ajaxGet(page){
		$.ajax({
			type: "GET",		
			url: "http://localhost:8080/lazapee/api/danh-muc/all" + "?page=" + page,
...
//    });
	...
	function ajaxPost(){
    	...
    	$.ajax({
			...
			url : "http://localhost:8080/lazapee/api/danh-muc/save",
    ...
    $(document).on("click",".btnCapNhatDanhMuc",function(){
		...
		var href = "http://localhost:8080/lazapee/api/danh-muc/"+danhMucId;
    ...
    function ajaxPut(){
    	...
    	$.ajax({
			...
			type : "PUT",
			contentType : "application/json",
			url : "http://localhost:8080/lazapee/api/danh-muc/update",
			data : JSON.stringify(formData),
            // dataType : 'json',
			success : function(response) {
